...
@section('content')
    <div class="container">
        <div class="col-lg-12">
            ...
            {!! Form::model($category, ['method'=>'PATCH', 'action'=>['\App\Http\Controllers\CategoriesController@update', $category->id]]) !!}
            <div class="row">
                @if ($errors->any())
                ...
                <div class="form-group col-md-6 mt-4">
                    {!! Form::submit(__("categories.edited"), ['class'=>'btn btn-primary']) !!}
                </div>
